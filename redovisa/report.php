...
<main>
    <article class="all-browsers">
        ...
        <section class="kmom">
            ...
            <ul>
                <li>main-style.css - håller i det allmänna</li>
            ...
            <p>
                Det här testet var enkelt att förstå. Det tog mig ändå en del tid att komma igång efter att jag lagt det åt sidan i nästan två veckor. Så det var en bra uppvärmning för senare deltest.<br>
            ...
            <p>
                ...
                Själva eventListner är en s.k. self-invoked funktion för att den är väldigt enkel. Den anropar <strong>showResults</strong> utifrån om svaret är rätt eller fel.
            </p>
            ...
            <p>
                Till slut gjorde jag om koden genom att lägga samtliga form-objekt in i en vektor som då skapas i en separat funktion <strong>defineAllObjects</strong> samt samtliga <strong>setTimeout id:er</strong> sparas i en annan vektor och i början av start-funktionen rensas samtliga events med hjälp av <strong>clearTimeout</strong>-funktionen.
                <p>
                    ...
                    <p>
                        Det mest krångliga var att (först upptäcka problem med och) fixa problem med <strong>setTimeout</strong>. Det är något som borde ha varnats för och tagits upp på förläsningarna. Alltså inte bara för att det svårt (det är egentligen inte) utan att man lätt missar att en sådan problematik över huvudtaget finns.<br>
                        Nu när jag tänker efter tycker jag att tidsstyrda händelser borde ha tagit mer tid under föreläsningen och gjorts en jämförelse med addEventListner med likheter och skillnader.
                    </p>
                    <p>
                        Kursmaterialet var faktiskt bra i synnerhet de inspelade (jag var aldrig med live) föreläsningar. Det som togs upp på föreläsningarna var både intressant/lärorikt och förklarat på ett roligt sätt.
                    </p>
                    <p>
                        I början trodde jag att kursen kommer vara för lätt men det tog farten och vi gick igenom en hel del. Tänker jag tillbaka har jag (äntligen efter så många år) fått en bra grund i javascript och mycket, mycket större förståelse av hur det hänger ihop än tidigare trots att jag första gången låtsatsprogrammerat redan i början på 2000 om jag nu minns rätt.
                    </p>
                    <p>
